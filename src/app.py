...
activities = {
    ...
    "Debate Team": {
        ...
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM; Competitions on select weekends",
        "max_participants": 15,
    ...
    "Science Olympiad": {
        ...
        "schedule": "Wednesdays, 3:45 PM - 5:45 PM",
        "max_participants": 20,
        "participants": ["sam@mergington.edu", "ina@mergington.edu"]
    }
}
